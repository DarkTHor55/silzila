...
public class SyncFilterQueryMysql {
    ...
    public static String getSyncFilterOptions(List<ColumnFilter> cf, String fromQuery, String venderName) throws BadRequestException {
        try {
            ...
            QueryClauseFieldListMap selectQuery = SelectClauseMysql.buildSelectClause(query, venderName, aliasMap);
            ...
            String whereClause = WhereClause.buildWhereClause(Collections.singletonList(panel), "mysql");

            // Append the WHERE clause to the final query
            finalQuery.append(whereClause);

            // Print the generated query for debugging
            System.out.println("Generated MySQL Query: " + finalQuery.toString());
